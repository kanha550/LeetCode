        ...
        <div className="relative bg-slate-800/90 backdrop-blur-xl rounded-2xl shadow-2xl border border-slate-700/50 overflow-hidden">
          ...
          <div className="p-8">
            ...
            <div className="grid grid-cols-2 gap-4 mb-6">
              <button 
                onClick={() => window.location.href = 'http://localhost:550/user/auth/google'}
                className="btn btn-outline border-slate-600 text-slate-300 hover:bg-slate-700 hover:border-slate-500"
              >
              ...
              <button 
                onClick={() => window.location.href = 'http://localhost:550/user/auth/github'}
                className="btn btn-outline border-slate-600 text-slate-300 hover:bg-slate-700 hover:border-slate-500"
              >
